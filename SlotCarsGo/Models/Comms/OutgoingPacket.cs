...
namespace SlotCarsGo.Models.Comms
{
    class OutgoingPacket
    {
        ...
        public OutgoingPacket(bool success)
        {
            if (success)
            {
                this.Data = new byte[] { SuccessByte, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, ZeroByte };
            }
            else
            {
                this.Data = new byte[] { NotRecognisedByte, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, ZeroByte };
            }
        }
        /*
                /// <summary>
